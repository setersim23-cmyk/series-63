...
import { C, fs, MONO_DISPLAY, SectionLabel, Tap, Title } from '../ui'
    ...
    <div style={{ padding: '20px 18px calc(120px + var(--safe-bottom))' }}>
      ...
      <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
        <Tap onClick={() => startQuiz('quick')} style={tile}>
          ...
          <div style={{ fontSize: fs(14), fontWeight: 600, marginTop: 6 }}>Quick 10</div>
          <div style={{ fontSize: fs(11), color: C.faint, marginTop: 2 }}>Adaptive — targets your weakest cells</div>
        </Tap>

        <Tap onClick={() => startQuiz('missed')} style={{ ...tile, border: `1px solid ${due ? 'var(--k7a3b2e)' : C.border}` }}>
          <div style={{ fontSize: fs(22) }}>↻</div>
          <div style={{ fontSize: fs(14), fontWeight: 600, marginTop: 6 }}>Missed queue</div>
          <div style={{ fontSize: fs(11), color: due ? 'var(--kff9a7a)' : C.faint, marginTop: 2 }}>
        ...
        <Tap onClick={() => startQuiz('hard')} style={tile}>
          <div style={{ fontSize: fs(22) }}>◆</div>
          <div style={{ fontSize: fs(14), fontWeight: 600, marginTop: 6 }}>The Hard 5</div>
          <div style={{ fontSize: fs(11), color: C.faint, marginTop: 2 }}>Multi-concept killers — exam-day difficulty</div>
        </Tap>

        <Tap onClick={startSim} style={tile}>
          <div style={{ fontSize: fs(22) }}>⚖</div>
          <div style={{ fontSize: fs(14), fontWeight: 600, marginTop: 6 }}>Administrator sim</div>
          <div style={{ fontSize: fs(11), color: C.faint, marginTop: 2 }}>4 enforcement cases — you make the calls</div>
        </Tap>
        ...
        >
          <div>
            <div style={{ fontSize: fs(14), fontWeight: 600, color: C.violet }}>🏛 Walk the whole palace</div>
        ...
        >
          <div>
            <div style={{ fontSize: fs(14), fontWeight: 600 }}>Timed mock exam</div>
