  ...
  return (
    <Tap
      ...
      style={{
        ...
        padding: '11px 13px',
        background: '#1c0d12',
        border: '1px solid #6e2a3d',
        display: 'flex',
        alignItems: 'center',
        gap: 10,
      }}
    >
      <div style={{ fontSize: 16, flex: 'none' }}>⚠</div>
      <div style={{ minWidth: 0 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: '#ff8aa8' }}>
          This copy can’t save your progress
        </div>
        <div style={{ fontSize: 11, color: '#b0798c', lineHeight: 1.5, marginTop: 2 }}>
      ...
      <div style={{ color: '#6e2a3d', fontSize: 16, flex: 'none' }}>›</div>
    </Tap>
  )
}
